...
ggplot(Ric_data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of knowledge")+ ylab("posterior probability")+ylim(0,1)
...
ggplot(Kri_data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of knowledge")+ ylab("posterior probability")+ylim(0,1)
...
ggplot(Jos_data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of knowledge")+ ylab("posterior probability")+ylim(0,1)
...
ggplot(Mik_data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of knowledge")+ ylab("posterior probability")+ylim(0,1)
