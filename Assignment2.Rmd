...
```{r setup, include=FALSE}
#Riccardo data
Ric = data.frame(matrix(0, ncol = 6, nrow = 1))
Ric[1:3] = 1;Ric
colnames(Ric)[1:6] = "answer"

#Kristian data
Kri = data.frame(matrix(0, ncol = 2, nrow =1))
Kri[1:2] = 1;Kri
colnames(Kri)[1:2] = "answer"

#Josh data
Jos = data.frame(matrix(0, ncol = 198, nrow =1))
Jos[1:160] = 1;Jos
colnames(Jos)[1:198] = "answer"

#Mikkel data
Mik = data.frame(matrix(0, ncol = 132, nrow =1))
Mik[1:66] = 1;Mik
colnames(Mik)[1:132] = "answer"
