...
Data= data.frame(grid=k_grid,posterior=posterior,prior=prior,likelihood=likelihood)
ggplot(Data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of water")+ ylab("posterior probability")
...
Data= data.frame(grid=J_grid,posterior=posterior,prior=prior,likelihood=likelihood)
ggplot(Data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of water")+ ylab("posterior probability")
...
# VERY low chance that Josh has absolute superpowers, but also that he knows nothing. Very stable teacher.
...
Data= data.frame(grid=M_grid,posterior=posterior,prior=prior,likelihood=likelihood)
ggplot(Data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of water")+ ylab("posterior probability")
